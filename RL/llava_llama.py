...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('/home/fmy/data/llava-v1.5-7b', use_fast=False)
    ...
    def forward(
        ...
        x_others: Optional[torch.Tensor] = None,
        generated_text: Optional[list] = None,
        decoding_scheme: Optional[str] = '',
        ori_data: Optional[list] = None,
